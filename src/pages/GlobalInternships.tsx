        ...
        >
          ...
          <div className="relative z-10 w-full max-w-6xl mx-auto px-4 py-16">
            ...
            >
              <motion.span
                variants={fadeInUp}
                className="inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-lg font-semibold backdrop-blur"
              >
                🌍 Doubleyou Global Internships
              </motion.span>
              <motion.h1
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xs text-center text-gray-500 mt-4">
              ...
              <a
                className="underline"
                href="https://form.typeform.com/to/vrcJPPLh"
                target="_blank"
                rel="noreferrer"
              >
                open in a new tab
